...
def main():
    ...
    #Save Prediction Result in mat file
    result_fn = './predic_result.mat'
    results = {'prediction': np.zeros((32,32,32))}
    results['prediction'] = voxel_prediction[0, :, 1, :, :] > cfg.TEST.VOXEL_THRESH
